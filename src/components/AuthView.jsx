  ...
  const handleAuth = async (e) => {
    ...
    try {
      if (mode === "signup") {
        ...
        setMessage({
          type: "success",
          text: "Authentication successful! Accessing vault...",
        });
      ...
      <div className="text-center space-y-2 mb-8">
        ...
        <p className="text-xs text-slate-400">
          {mode === "update-password"
            ? "Provide a new security password for vault authorization."
            : "Access historical correction data, active clear-coat specs, and pending reservations."}
        </p>
      </div>

      {message.text && (
        <div
          className={`mb-6 p-4 border rounded-xl text-xs text-center font-medium animate-fade-in shadow-lg ${
          ...
          {mode !== "update-password" && (
            <div className="space-y-1">
              ...
              <input
                type="email"
                required
                placeholder="client@apexstudio.com"
                value={email}
